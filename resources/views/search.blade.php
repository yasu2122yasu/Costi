          ...
          <div class="text-center title-color"><label for="carrier">大手キャリアを利用したいですか？</label></div>
           <div class="container">
            <div class="radio-tile-group">
              ...
              <div class="input-container">
                <input class="radio-button" type="radio" id="carrier" name="carrier" value="1" @if(isset($old_carrier) && (int)$old_carrier == 1) checked @endif>
                <div class="radio-tile">
              ...
              <div class="input-container">
                <input class="radio-button" type="radio" id="carrier" name="carrier" value="2" @if(isset($old_carrier) && (int)$old_carrier == 2) checked @endif>
                <div class="radio-tile">
